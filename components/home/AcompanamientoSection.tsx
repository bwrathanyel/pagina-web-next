...
export function AcompanamientoSection() {
  ...
  return (
    <section className="grano relative bg-dusk-2 px-5 py-[var(--ritmo-seccion)] text-dusk-text md:py-[var(--ritmo-seccion-md)]">
      <Revelar as="div" className="mx-auto grid max-w-[var(--ancho-contenido)] gap-6 md:grid-cols-[1.3fr_1fr] md:items-center md:gap-10">
        <EditableText path="home.trust.headline" as="h2" className="max-w-[18ch] text-balance font-display text-2xl font-semibold leading-tight md:text-4xl" />
