    ...
    <nav aria-label="Contacto rápido">
      ...
      >
        <WhatsAppLeadButton
          ...
          triggerTitle="Escríbenos por WhatsApp"
          triggerClassName="flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-white shadow-[0_10px_28px_-8px_rgba(15,122,64,0.55)]"
        >
